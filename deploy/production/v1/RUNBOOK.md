...
3. When reverting across migration 008, migration 010, migration 011, migration 012, migration 013, or migration 014, always move the current
   ...
   a firm the operator archived. Pre-014 code does not claim the separate website-reprocessing queue or use website evidence in QC.
