...
3. When reverting across migration 008, migration 010, migration 011, migration 012, or migration 013, always move the current
   ...
   a firm the operator archived. Restore owner `govscout:govscout` and mode
   `0600`.
